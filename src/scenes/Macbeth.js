class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.duncan = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'duncan').setOrigin(0, 1).setScale(0.4);
        this.malcolm = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'malcolm').setOrigin(0, 1);
        this.sergeant = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'sergeant').setOrigin(0, 1).setScale(0.15);
